...
const categoryColors = {
  ...
  Asprak: "bg-emerald-50 text-emerald-700 border-emerald-200 hover:border-emerald-300",
  Himpunan: "bg-purple-50 text-purple-700 border-purple-200 hover:border-purple-300",
  Seminar: "bg-amber-50 text-amber-700 border-amber-200 hover:border-amber-300",
  Lainnya: "bg-slate-50 text-slate-700 border-slate-200 hover:border-slate-300",
};

const categories = ["Dicoding", "Asprak", "Himpunan", "Seminar", "Lainnya"];
