...
def build_document(template: Path, output: Path) -> None:
    with zipfile.ZipFile(template, "r") as zin:
        ...
        paragraphs = [
            ...
            role("Bachelor of Informatics Engineering, GPA: 3.56/4.00 (Graduated 3 July 2025)"),
            ...
            bullet("Delivered 1 MBKM sharing session to explain independent-study and internship pathways for Informatics students."),
