...
const certificates = [
  ...
  // ========== TEACHING ASSISTANT ==========
  { name: "Asisten Energi ITERA (AEI)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sakti Mujahid Imani AEI.pdf" },
  { name: "Asisten Fisika 2 (2023-2024)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asisten Fisika 2 2023-2024.pdf" },
  { name: "Asprak Fisdas I (2023)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak Fisdas I 2023.pdf" },
  { name: "Asprak Fisdas I (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/SERTIFIKAT ASPRAK FISDAS I TA 2024-2025.pdf" },
  { name: "Asprak Fisdas II (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/SERTIFIKAT ASPRAK FISDAS II TA 2024-2025.pdf" },
  { name: "Asprak Matriks dan Ruang Vektor (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak Matriks dan Ruang Vektor 2024-2025.pdf" },
  { name: "Asprak Pengenalan Prodi TI (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak Pengenalan Prodi Teknik Informatika 2024-2025.pdf" },
  { name: "Asprak PKS 1 (2023-2024)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak PKS 1 2023-2024.pdf" },
  { name: "Asprak PKS 1 (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak PKS 1 2024-2025.pdf" },
  { name: "Asprak PKS 2 (2023-2024)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak PKS 2 2023-2024.pdf" },
  { name: "Asprak Teori Bahasa Formal dan Otomata (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/Sertifikat Asprak Teori Bahasa Formal dan Otomata - 2024-205.pdf" },
  { name: "Kordas Fisdas I (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/SERTIFIKAT KORDAS FISDAS I TA 2024-2025.pdf" },
  { name: "Kordas Fisdas II (2024-2025)", category: "Teaching Assistant", path: "/sertifikat/asprak/SERTIFIKAT KORDAS FISDAS II TA 2024-2025.pdf" },
  ...
  // ========== OTHERS ==========
  { name: "Data Analytics — RevoU", category: "Others", path: "/sertifikat/lainnya/Data Analytics RevoU.pdf" },
  { name: "Digistar by Telkom Indonesia", category: "Others", path: "/sertifikat/lainnya/Digistar Sakti Mujahid Imani.pdf" },
  { name: "DFIR Foundations — Blue Cape Security", category: "Others", path: "/sertifikat/lainnya/saktimujahid.9b-DFIR-Foundations-and-Techniques-DFIR-Foundations-Techniques-Professional-Skills-and-Readiness-Blue-Cape-Security.pdf" },
